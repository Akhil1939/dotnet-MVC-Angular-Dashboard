...
namespace MVC_Angular_demo.Extensions
{
    public static class BundleCollectionExtensions
    {
        public static void AddScripts(this BundleCollection bundles)
        {
            ...
            bundles.Add(new Bundle("~/bundles/angular/app").Include(
                      "~/Scripts/Angular/build_package/app.*"
                      ));
            //bundles.Add(new Bundle("~/bundles/angular/shared/another-module").Include(
            //          "~/Scripts/Angular/build_package/another_module.*"
                      //));
            bundles.Add(new Bundle("~/bundles/angular/admin-module").Include(
                      "~/Scripts/Angular/build_package/admin_module.*"
                      ));
            bundles.Add(new Bundle("~/bundles/angular/user-module").Include(
                      "~/Scripts/Angular/build_package/user_module.*"
                      ));
            bundles.Add(new Bundle("~/bundles/angular/role-module").Include(
                     "~/Scripts/Angular/build_package/role_module.*"
                     ));
        }
